...
import { useOrderDetails, useUserShippingInfo } from "./query";
      ...
      <MansCard className="container">
        <div>
          ...
          <OrderDetailContainer className="col-span-4 grid grid-cols-4 items-center">
            ...
            <span className="col-start-4 justify-center text-center">
              {cf(total)}
            </span>
          </OrderDetailContainer>
        </div>
        ...
        <div className="flex flex-wrap gap-3 pt-6">
          ...
          >
            <h3>This could take 3-5 business days.</h3>
          </MansDialog>
          <MansDialog
            triggerFn={({ toggle }) => (
              <MansButton type="button" onClick={toggle}>
          ...
          >
            <h3>We will send you another confirmation email.</h3>
          </MansDialog>
          <MansDialog
            triggerFn={({ toggle }) => (
              <MansButton type="button" onClick={toggle}>
          ...
          >
            <h3>
              Check your inbox and spam folder for the tracking link of our
              courier.
            </h3>
          </MansDialog>
        </div>
